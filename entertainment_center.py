...
toy_story = media.Movie('Toy Story',
                        ...
                        'https://www.youtube.com/watch?v=4KPTXpQehio', '1995') #noqa

avatar = media.Movie('Avatar',
                     'A marine on an alien planet',
                     'https://upload.wikimedia.org/wikipedia/en/b/b0/Avatar-Teaser-Poster.jpg',
                     'https://www.youtube.com/watch?v=5PSNL1qE6VY', '2009') #noqa

inception = media.Movie('Inception',
                     'A man who hacked peoples dream',
                     'https://upload.wikimedia.org/wikipedia/en/2/2e/Inception_%282010%29_theatrical_poster.jpg',
                     'https://www.youtube.com/watch?v=d3A3-zSOBT4', '2010') #noqa
...
distric_9 = media.Movie('Distric 9',
                     ...
                     'https://www.youtube.com/watch?v=DyLUwOcR5pk', '2009') #noqa
...
world_war_z = media.Movie('World War Z',
                     ...
                     'https://www.youtube.com/watch?v=HcwTxRuq-uk','2013') #noqa
...
chefs_table = media.Movie('Chefs Table',
                     ...
                     'https://www.youtube.com/watch?v=qKqj85oo2wI', '2015') #noqa

#create a list of movies for fresh_tomatoes
